...
details.Technique = dr["Technique"].ToString();
...
public static bool UpdateCategory(string id, string name, string description)
{
    ...
    public static bool DeleteCategory(string id)
    {
        ...
        public static DataTable GetAllProductsInCategory(string categoryId)
            ...
            public static bool CreateProduct(string categoryId, string name,string description, string price, string Thumbnail, string Image, string Technique, string PromoDept, string PromoFront)
            {
                // get a configured DbCommand object
                DbCommand comm = GenericDataAccess.CreateCommand();
                // set the stored procedure name
                ...
                // create a new parameter
                param = comm.CreateParameter();
                param.ParameterName = "@ProductTechnique";
                param.Value = Technique;
                param.DbType = DbType.String;
                comm.Parameters.Add(param);
                // create a new parameter
                param = comm.CreateParameter();
        ...
        public static bool UpdateProduct(string productId, string name, string description, string price, string Thumbnail, string Image, string Technique, string PromoDept, string PromoFront)
        {
            // get a configured DbCommand object
            DbCommand comm = GenericDataAccess.CreateCommand();
            // set the stored procedure name
