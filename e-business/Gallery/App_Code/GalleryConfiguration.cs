...
/// <summary>
/// Repository for Gallery configuration settings
/// </summary>
public static class GalleryConfiguration
{
    ...
    {
        dbConnectionString = ConfigurationManager.ConnectionStrings["GalleryConnection"].ConnectionString;
        dbProviderName = ConfigurationManager.ConnectionStrings["GalleryConnection"].ProviderName;
    ...
    // Returns the connection string for the Gallery database
    ...
    public static string CustomerServiceEmail
    {
        ...
        {
            return
               ConfigurationManager.AppSettings["smtp.testing.email@gmail.com"];
        }
    }
    ...
    public static string OrderProcessorEmail
    {
        ...
        {
            return
               ConfigurationManager.AppSettings["customer@mysite.com"];
        }
    }
    ...
    public static string SupplierEmail
    {
        get
        {
            return ConfigurationManager.AppSettings["smtp.testing.email@gmail.com"];
        }
    }
