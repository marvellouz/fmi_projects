...
// Populate the GridView with data
    ...
    protected void grid_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
        ...
        grid.EditIndex = -1;
        // Set status message
        statusLabel.Text = "Промяната е отменена";
        // Reload the grid
        BindGrid();
    }
    protected void grid_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            string technique = ((TextBox)grid.Rows[e.RowIndex].FindControl("techniqueTextBox")).Text;
            ...
            bool success = CatalogAccess.UpdateProduct(id, name, description, price, thumbnail, technique, image, promoDept, promoFront);
            // Cancel edit mode
            grid.EditIndex = -1;
    ...
    protected void createProduct_Click(object sender, EventArgs e)
    {
        ...
        bool success = CatalogAccess.CreateProduct(categoryId, newName.Text,newDescription.Text, newPrice.Text, newThumbnail.Text, newImage.Text, newTechnique.Text, newPromoDept.Checked.ToString(), newPromoFront.Checked.ToString());
        // Display status message
